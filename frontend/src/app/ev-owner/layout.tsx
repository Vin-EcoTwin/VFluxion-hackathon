...
export default function EvOwnerLayout({ children }: { children: ReactNode }) {
  return (
    <div className={`light bg-background text-on-surface h-screen w-screen overflow-hidden flex font-body-md selection:bg-primary/20 selection:text-primary ${manropeFont.variable} ${interFont.variable}`}>
      <SideNavBar />
